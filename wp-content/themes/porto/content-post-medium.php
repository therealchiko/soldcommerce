...
<article <?php post_class($post_class); ?>>
    ...
    <div class="row">
        ...
        <div class="post-meta">
            ...
            <?php endif; ?>
            <?php if (in_array('comments', $porto_settings['post-metas'])) : ?><span class="meta-comments"><i class="fa fa-comments"></i> <?php comments_popup_link(__('0 Comments', 'porto'), __('1 Comment', 'porto'), '% '.__('Comments', 'porto')); ?></span><?php endif; ?>			<?php if (in_array('like', $porto_settings['post-metas'])) : ?>
