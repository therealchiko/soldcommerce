...
$output .= '<article class="timeline-box right ' .$el_class.'">';
	$output .= '<div class="experience-info col-md-3 col-sm-5 match-height background-color-primary">';
		...
		$output .= '</span>';
	$output .= '</div>';
	$output .= '<div class="experience-description col-md-9 col-sm-7 match-height background-color-light">';
